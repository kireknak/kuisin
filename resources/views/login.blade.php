...
@section('content')<section class="position-relative py-4 py-xl-5">
    <div class="container">
        <div class="row mb-5">
                ...
                <div class="card mb-5">
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <form class="text-center" method="post" >
                            ...
                            <div class="mb-3"></div>
                            <p class="text-muted">Lupa Password?</p><button class="btn btn-primary d-block w-100" type="submit">Login</button>
                        </form>
                    </div>
                </div>
                <p class="text-muted">Belum Punya Akun? <a href="{{ route('register') }}">Daftar Disini</a></p>
            </div>
        </div>
    </div>
</section>
